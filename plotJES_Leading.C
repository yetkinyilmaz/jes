...
void plotJES_Leading(double cc = 1.03, double ss = 0, double nn = 0, string var = "xj", bool doMC = 1, bool doPP = 0){
  ...
  t3->Draw();
  c2->Print(Form("figure_sys_jes_lead_legend_c%d.png",int(c*100)));
